package com.huashanlunjian.alice_mad_tea_party.client.model;
...
public class EntityFairyModel extends EntityModel<DollEntity> {
    public static ModelLayerLocation LAYER = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Alice_mad_tea_party.MOD_ID, "main"), "fairy");
    ...
    @Override
    public void setupAnim(DollEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
